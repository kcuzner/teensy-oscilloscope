...
**
**     Abstract:
**         This header file implements peripheral memory map for MKE02Z4
**         processor.
**
 ...
 * @version 1.0
 * @date 2013-12-19
 * @brief Peripheral memory map for MKE02Z4
 *
 * This header file implements peripheral memory map for MKE02Z4 processor.
 */
