...
**
**     Abstract:
**         This header file implements peripheral memory map for MKL34Z4
**         processor.
**
 ...
 * @version 1.1
 * @date 2013-04-05
 * @brief Peripheral memory map for MKL34Z4
 *
 * This header file implements peripheral memory map for MKL34Z4 processor.
 */
...
#if !defined(MCU_MKL34Z4)  /* Check if memory map has not been already included */
#define MCU_MKL34Z4
